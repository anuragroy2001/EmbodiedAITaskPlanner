...
### 1. Clone the Repo
```bash
git clone https://github.com/anuragroy2001/EmbodiedAITaskPlanner.git
cd EmbodiedAITaskPlanner
```
...
6. Explore the results:
   - ??? **MAP** ? Interactive floor plan with clickable object boxes
   - ?? **GRAPH** ? D3.js semantic relationship graph
   - ?? **TWIN** ? 3D voxel digital twin view
7. Use the **Plan Q&A** interface to describe a task and get an interactive plan
